...
33 and 65 in the two respective files.
...
\todo{ramon: explain. what would be the correct code?}


Since we only want to verify the addition of satoshis, and the Satoshis class overrides A with Int64 anyway,  we just remove the abstract type and set it to Int64.
