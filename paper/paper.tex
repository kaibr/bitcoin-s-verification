...
general do not have all the methods of the Scala data types. We will see an example of a method 
of the BigInt type that Scala provides but Stainless does not.
\todo{question viktor: where is BigInt??}
