...
\cite{Stainless:documentation,Stainless:github}. It is intended to be
...
The following example from \cite{Stainless:documentation} demonstrates
this. Notice how a precondition is specified using the function
\emph{require} and a postcondition using \emph{ensuring}.
...
Our program happens to not satisfy the specification. An overflow in
