...
% [  Info  ] ╔═╡ stainless summary ╞═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
% [  Info  ] ║ └───────────────────┘                                                                                                                                                                             ║
% [  Info  ] ║ +      postcondition                                                 valid             U:smt-z3  ../../../../../bin/../src/main/scala/addition/modified/currency/CurrencyUnits.scala:12:3   0.643 ║
% [  Info  ] ║ +      precond. (call +(underlying(satoshis(thiss)), underlyin ...)  valid from cache            ../../../../../bin/../src/main/scala/addition/modified/currency/CurrencyUnits.scala:14:14  0.097 ║
% [  Info  ] ║ +      precond. (call checkResult(thiss, underlying(thiss) + u ...)  valid from cache            ../../../../../bin/../src/main/scala/addition/modified/number/NumberType.scala:22:11       0.015 ║
% [  Info  ] ║ apply  adt invariant                                                 valid from cache            ../../../../../bin/../src/main/scala/addition/modified/currency/CurrencyUnits.scala:34:39  0.005 ║
% [  Info  ] ║ apply  precond. (call apply(Int64(), bigInt))                        valid             U:smt-z3  ../../../../../bin/../src/main/scala/addition/modified/number/NumberType.scala:52:5        0.187 ║
% [  Info  ] ║ apply  adt invariant                                                 valid from cache            ../../../../../bin/../src/main/scala/addition/modified/number/NumberType.scala:79:5        0.017 ║
% [  Info  ] ║ max    precond. (call apply(Int64(), 9223372036854775807))           valid from cache            ../../../../../bin/../src/main/scala/addition/modified/number/NumberType.scala:72:18       0.001 ║
% [  Info  ] ║ min    precond. (call apply(Int64(), -9223372036854775808))          valid from cache            ../../../../../bin/../src/main/scala/addition/modified/number/NumberType.scala:71:18       0.001 ║
% [  Info  ] ║ one    precond. (call apply(Int64(), 1))                             valid from cache            ../../../../../bin/../src/main/scala/addition/modified/number/NumberType.scala:69:18       0.915 ║
% [  Info  ] ║ zero   precond. (call apply(Int64(), 0))                             valid from cache            ../../../../../bin/../src/main/scala/addition/modified/number/NumberType.scala:68:19       0.001 ║
% [  Info  ] ╟┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄╢
