...
\title{Towards Verifying the Bitcoin-S Library} %TODO Please add
...
\authorrunning{R. Boss and K. Brünnler and A. Doukmak} %TODO mandatory. First: Use abbreviated first/middle names. Second (only in severe cases): Use first author plus 'et al.'

\Copyright{Ramon Boss and Kai Brünnler and Anna Doukmak} %TODO mandatory, please use full first names. OASIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
...
\keywords{Bitcoin, Scala, Bitcoin-S, Stainless} %TODO mandatory; please add comma-separated list of keywords
...
% \dots}%optional, to capture a funding statement, which applies to all authors. Please enter author specific funding statements as fifth argument of the \author macro.
