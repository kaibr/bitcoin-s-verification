...
The issue \mypound520 on Stainless GitHub\footnote{\url{https://github.com/epfl-lara/stainless/issues/520}} gives some thoughts if you want to know more.
...
To track this, there is the issue \mypound519 on GitHub\footnote{\url{https://github.com/epfl-lara/stainless/issues/519}}.
\begin{lstlisting}[language=scala]
...
This was a missing feature of Stainless that was fixed on Mai 28, 2019 with pull request \mypound470 on GitHub\footnote{\url{https://github.com/epfl-lara/stainless/pull/470}}.
...
\section{Removeing Second Parameter of require}
