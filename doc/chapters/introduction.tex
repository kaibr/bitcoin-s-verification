...
\textit{ensuring} specifies, if the return value or the result of the function hold a certain condition.
...
It recursively calculates factorial of an integer number.
...
In Bitcoin-S there is a class Satoshis representing an amount of bitcoins.
