...
This chapter describes the part of Bitcoin-S needed to verify our property.
...
Some of the code in this section is copied or adapted parts of Bitcoin-S-Core transaction builder example.\cite{BitcoinSCore:txbuilderexample}
...
This transaction can be parsed from the bitcoin network but we create a transaction manually in order to see this process.

// TODO explain more. We create a fake transaction blabla
...
This was fixed in pull request \mypound435 on GitHub\footnote{\url{https://github.com/bitcoin-s/bitcoin-s/pull/435}} at April 23, 2019 by us along a unit test to prevent this bug from appearing again in the future.
